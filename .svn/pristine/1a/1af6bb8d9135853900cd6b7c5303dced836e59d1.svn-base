		...
		<div class="col-sm-12 card widget-inline p-0">
			...
			<div class="col-sm-5 ms-auto me-3 card widget-inline p-3 d-grid gap-2">
				<div class="col-md-12 justify-content-between">
					<div class="col-md-6 text-primary font-24" style="float:left;"><i class="uil-exclamation-circle"></i>신규 주문 <strong>2</strong>건</div>
					<div class="col-md-6 d-flex justify-content-end" style="float:left;"><button type="button" class="btn btn-sm btn-danger">더보기</button></div>
				</div>
				<div class="col-12">
					<div class="col-md-12 text-muted font-16">신규 데이터 최대 5건만 조회되며, 모두 보려면 <strong>더보기</strong>를 클릭하세요</div>
				</div>
<!-- 				<div class="row"> -->
					...
					<table class="table mb-1 table-hover" style="background-color:#B2FF66;border-radius:25px;">
					    <tbody>
					        <tr>
					            <td>Risa D. Pearson</td>
					            <td>336-508-2157</td>
...
<!-- 				</div> -->
			...
			<div class="col-sm-5 card widget-inline p-3 gap-1 ms-3 me-auto">
				<div class="col-md-12">
					<div class="col-md-6 text-danger font-24" style="float:left"><i class="uil-exclamation-circle"></i>가맹점미납 <strong>2</strong>건</div>
					<div class="col-md-6 d-flex justify-content-end" style="float:left"><button type="button" class="btn btn-sm btn-danger">더보기</button></div>
				</div>
				<div class="col-md-12">
					<div class="col-md-12 text-muted font-16">신규 데이터 최대 5건만 조회되며, 모두 보려면 <strong>더보기</strong>를 클릭하세요</div>
				...
				<table class="table mb-1 table-hover" style="background-color:#FF9090;border-radius:25px;border:disabled;">
					...
					<table class="table mb-1 table-hover" style="background-color:#FF9090;border-radius:25px;">
					    <tbody>
					        <tr>
					            <td>Risa D. Pearson</td>
					            <td>336-508-2157</td>
