	...
	function displayInfowindow(marker, title) {
		...
		if(title.memId != '${member.memId}'){
			...
			if(title.reviewYn == 'N'){
			    ...
			    + '<div style="color: #f5f5f5; border-bottom: 2px solid; width:163px"></div>'
				+ '<div class="star-rating"><div class="d-flex stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><div class="ms-2 print" style="color: black;" name="review" id="review"></div><div style="color: black;">/5</div></div></div>'
			    + '<div style="padding-left: 10px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px;">'
			    + '<textarea rows="10" cols="20" class="m-2" name="reviewContent" id="reviewContent"></textarea>'
				+ '</div>'
				+ '<input type="button" id="reviewBtn" style="padding:5px; margin-left: 55px; margin-bottom: 20px; z-index:1; color:black;" value="리뷰쓰기" />'
			    + '<sec:csrfInput/></form>';
			}else {
				var content = '<div style="padding:5px;z-index:1;color:black;">' + title.frcsName + '</div>'
			    + '<div style="color: #f5f5f5; border-bottom: 2px solid; width:146px"></div>'
