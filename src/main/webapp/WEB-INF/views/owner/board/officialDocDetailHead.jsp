	                    ...
	                    <div class="card-body">
	                        ...
	                        <div class="page-aside-right">
								...
								<div class="my-3 overflow-auto" style="height: 300px" >
									${officeLetterVO.hdLtcontent }
								</div>
								
								<hr />
								
<!-- 								첨부파일이 있으면 보이도록하기 -->
								<c:set value="${officeLetterVO.officeLetterFileList }" var="officeLetterFileList"/>
								<c:if test="${not empty officeLetterFileList}">
									<h5 class="mt-3 mb-3">첨부파일</h5>
									<div class="row">
										<c:forEach items="${officeLetterFileList}" var="HofldcFile">
											<div class="col-xl-4">
												<div class="card mb-1 shadow-none border">
													<div class="p-2">
														<div class="row align-items-center">
															...
															<div class="col ps-0">
																<a href="javascript:void(0);" class="text-muted fw-bold">${HofldcFile.attachOrgname }</a>
																<p class="mb-0">${HofldcFile.attachSize } MB</p>
															</div>
															<div class="col-auto">
																<!-- Button -->
																<button type="button"
																		class="btn btn-link btn-lg fileDownload"
																		data-attach-no="${HofldcFile.attachNo }" name="attachNo"><i class="ri-download-2-line" ></i></button>
															</div>
														</div>
													</div>
												</div>
