...
<div id="menubar" class="d-flex align-items-center h-75 d-inline-block align-middle">
	<div class="container position-relative text-center text-lg-center"
		...
		<div class="row" style="height: 400px">
			...
			<div class="col-4 d-flex justify-content-center align-items-center">
				<a href="/elly/noticeilist.do"><img src="../resources/img/right.png" style="width: 30px; height: 30px;" alt="마른안주"></a>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-10 bg-white">
				...
				<div class="mb-5">
					<p class="d-flex justify-content-center" style="color: black; font-size: 2.5rem;">건의합니다</p>
				</div>
						...
						<c:choose>
							...
							<c:forEach items="${boardList }" var="board">
								<div class="row text-center">
									...
									<div class="col">
										<a href="/elly/tendidetail.do?tableNo=${board.tableNo }">${board.boardTitle }</a></td>
									</div>
									<div class="col-1">
										${board.memId }
									</div>
...
<!-- 									<div class="col-1"> -->
<%-- 										<a href="/elly/tendiupdate.do?tableNo=${board.tableNo }" class="action-icon"> <i class="mdi mdi-pencil"></i></a> --%>
<!-- 									</div> -->
									<div class="mt-4 mb-4" style="color: #f5f5f5; border-bottom: 1px solid;"></div>
								</div>
							</c:forEach>
				...
				<!-- 페이징 버튼 시작 -->
				<div class="mb-5 pagination justify-content-center text-dark" id="tendipagingArea"> ${pagingVO.pagingHTML }</div>
				<!-- 페이징 버튼 끝 -->
...
$(function(){
	 ...
	 var tendipagingArea = $("#tendipagingArea");
	 var btnForm = $("#btnForm");
	 
	 tendipagingArea.on("click", "a", function(event){
	 ...
	 btnForm.on("click", function(){
		 location.href = "/elly/tendiform.do";
	 });
});
</script>