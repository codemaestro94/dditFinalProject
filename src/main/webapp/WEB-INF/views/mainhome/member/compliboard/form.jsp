...
<!-- 제목 시작 -->
  <section class="inner-page w-75 p-3 mx-auto">
			...
			<div class="mb-5">
				<p class="d-flex justify-content-center" style="color: black; font-size: 2.5rem;">칭찬게시판  ${name }</p>
			</div>
	</section>
...
<div class="mb-4" style="color: rgb(0, 0, 0); border-bottom: 3px solid;"></div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="">
				<form action="/elly/insert.do" method="post" id="boardForm">
				<c:if test="${status eq 'u' }">
...
// 		if(ws.readyState !== 1) return;
	...
	cancleBtn.on("click", function(){
		...
		location.href = "/elly/detail.do?tableNo=" + tableNo;
	});
