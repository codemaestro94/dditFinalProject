			...
			<div class="col-sm-12 card widget-inline mt-3" style="height: 100px;">
				<div class="row ">
					<div class="card-body col-4 align-items-center">
						<div class="col-sm-6 page-title text-primary font-24 ms-3 fw-bold">칭찬합니다</div>
						<div class="col-sm-12 page-title-sub text-muted font-14 ms-3">고객이 올린 칭찬글을 조회할 수 있습니다.</div>
					</div>
					<div
						class="card-body col-6 fw-bold font-15 d-flex justify-content-end align-items-center me-5">
						게시판 > &nbsp;<span class="text-decoration-underline">칭찬합니다</span>
					</div>
				</div>
			</div>
			<!-- end page title -->
