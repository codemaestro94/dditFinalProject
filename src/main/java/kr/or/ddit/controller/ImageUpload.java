...
public class ImageUpload {
   ...
   public String imageUpload(
         ...
         HttpServletResponse resp, MultipartHttpServletRequest multiFile) throws IOException {
            ...
            if(contentType != null && contentType.toLowerCase().startsWith("image/")) {
               ...
               if(file.getSize() > limitSize) { //최대 크기 2MB보다 클 때
                  ...
                  try {
                     ...
                     String uploadPath = req.getServletContext().getRealPath("/resources/upload/img"); //업로드 경로 설정
//                     String uploadPath = "D:\\99.JSP_SPRING\\02.Spring2\\workspace_spring2\\Elemental\\src\\main\\webapp\\resources\\upload\\img";
//                     String uploadPath = "\\\\192.168.144.41\\ddit404\\finalproject\\Elemental\\resources\\upload\\img";
                     ...
                     uploadPath = uploadPath + "/" + fileName + ".png"; // 업로드 경로 + 파일명.jsp
                      ...
                      */
                     String fileUrl = req.getContextPath() + "/resources/upload/img/" + fileName +".png";
//                     String fileUrl = req.getContextPath() + "\\\\192.168.144.41\\ddit404\\finalproject\\Elemental\\resources\\upload\\img" + fileName +".jpg";
