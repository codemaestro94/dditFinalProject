			...
			<div class="col-sm-12 card widget-inline mt-3" style="height: 100px;">
				<div class="row ">
					<div class="card-body col-4 align-items-center">
						<div class="col-sm-6 page-title text-primary font-24 ms-3 fw-bold">FAQ</div>
						<div class="col-sm-12 page-title-sub text-muted font-14 ms-3">FAQ를
							관리합니다.</div>
					</div>
					<div
						class="card-body col-6 fw-bold font-15 d-flex justify-content-end align-items-center me-5">
						게시판 > &nbsp;<span class="text-decoration-underline">FAQ</span>
					</div>
				</div>
			</div>
			<!-- end page title -->
											...
											<c:otherwise>
												<c:forEach items="${boardList }" var="headBoardVO">
													<tr>
														...
														<td><a
															href="/head/faqdetail.do?boardNo=${headBoardVO.boardNo }">${headBoardVO.boardTitle }</a>
														</td>
														<td>관리자</td>
														<td><fmt:formatDate
...
$(function(){
	...
	subBtn.on("click", function(){
		window.location.href="/head/faqform.do";
	});
