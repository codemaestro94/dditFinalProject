				...
				<ul>
					<li class="dropdown">
						...
						<ul>
							...
							<li><a href="/elly/mypage.do?memId=${member.memId }">마이페이지</a></li>
							<li><a href="/elly/mypage/res.do?memId=${member.memId }">예약내역조회</a></li>
							<li><a href="/elly/mypage/coupon.do?memId=${member.memId }">내 쿠폰함</a></li>
...
<div id="commonMypage">
	<section class="ps-5 pe-5">
		<div class="mb-5">
			<a href="/elly/mypage.do?memId=${member.memId }" class="" style="font-size: 2rem;">My Page</a>
		...
		<div class="container-fluid">
		    <div class="row">
		        <div class="col-md-2 d-flex align-items-center justify-content-center">
		                <img src="${pageContext.request.contextPath}/resources/assets/images/users/avatar-11.png" alt="user-image" width="190" class="rounded-circle">
		        </div>
		        <div class="col-md-5 d-inline-block">
	                <div class="">
	                    ...
	                    <a href="/elly/mypage/update.do?memId=${member.memId }">회원정보변경</a>
	                </div><br/>
	                <div class="">
	                    <span>가입일 : <fmt:formatDate value="${memberVO.memRegdate }" pattern="yyyy.MM.dd"/></span>
	                </div>
	                <p class="">
	                	<sec:authentication property="principal.member.memName"/>님 다음 등급인 골드 4번 남았습니다.
	                    <a href="/elly/faqlist.do">등급혜택 &gt;</a>
	                </p>
		        </div>
		        <div class="col-md-5 d-inline-block">		            
		            <div class="row">
		            	<div class="col-md-4 mt-5">
			            	<div class="mb-3">
				                <img src="${pageContext.request.contextPath}/resources/assets/images/users/avatar-13.png" alt="user-image" width="38" class=""><br/>
			            	</div>
							<div class="mb-3">
			                	<a href="/elly/mypage/coupon.do?memId=${member.memId }"><span>쿠폰 &gt;</span></a>
			                </div>
			            	<div>
		            	...
		            	<div class="col-md-4 mt-5">
		                	<div class="mb-3">
		                		<img src="${pageContext.request.contextPath}/resources/assets/images/users/avatar-14.png" alt="user-image" width="38" class="" >
		                	</div>
		                	<div class="mb-3">
		                		<a href="/elly/mypage/review.do?memId=${member.memId }"><span>리뷰 작성 &gt;</span></a>
		                	</div>
		                	<div>
		                		<span>${myreviewCnt }</span>
		                	</div>
		                </div>
		            	<div class="col-md-4 mt-5">
		                	<div class="mb-3">
		                		<img src="${pageContext.request.contextPath}/resources/assets/images/users/avatar-15.png" alt="user-image" width="38" class="">
		                	</div>
		                	<div class="mb-3">
		                		<a href="/elly/mypage/res.do?memId=${member.memId }"><span>예약 횟수 &gt;</span></a>
		                	</div>
		                	<div>
		                		<span>${myresCnt }</span>
		                	</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2 pt-5 pb-5 ps-5 bg-white">
				<div class="mb-4">
					<a href="/elly/mypage.do?memId=${member.memId }" style="color: rgb(20, 170, 255);">마이페이지</a>
				</div>
				<div class="mb-4">
					<h3 style="color: rgb(0, 0, 0)">내 정보</h3>
				</div>
				<div class="mb-4">
					<a href="/elly/mypage/res.do?memId=${member.memId }" class="d-block" style="color: rgb(110, 110, 110)">예약 내역 조회</a>
				</div>
				<div class="mb-4">
					<a href="/elly/mypage/coupon.do?memId=${member.memId }" class="d-block" style="color: rgb(110, 110, 110)">쿠폰함</a>
				</div>
				<div class="mt-5 mb-4">
					<h3 style="color: rgb(0, 0, 0)">커뮤니티</h3>
				</div>
				<div class="mb-4">
					<a href="/elly/mypage/board.do?memId=${member.memId }" class="d-block" style="color: rgb(110, 110, 110)">칭찬 & 건의</a>
				</div>
				<div class="mb-4">
					<a href="/elly/mypage/review.do?memId=${member.memId }" class="d-block" style="color: rgb(110, 110, 110)">리뷰 내역 조회</a>
				</div>
				<div class="mb-4">
